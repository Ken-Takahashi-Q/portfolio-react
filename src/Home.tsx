    ...
    <div className="homepage">
      ...
      <div className="experience-section">
        ...
        <div className="work-section">
          <div className="work-section left-side">
            <span className="work-position">
              <h2>Fullstack Developer</h2> The Able by King Power
            </span>
            <ul>
              <li>
                <span>
                  <strong>Contributed</strong> in Core Engineering team to
                  modernize Point-of-Sale (POS) systems using C# .NET, improving
                  system scalability and error tracking
                </span>
              </li>
              <li id="exp-2">
                <span>
          ...
          <div className="work-section right-side 5">
            <div className="logo cs">
              <img src="/images/home/cs.png"></img>
              <h2>C#</h2>
            </div>
            <div className="logo dotnet">
              <img src="/images/home/dotnet.png"></img>
              <h2>.NET</h2>
            </div>
            <div className="logo typescript">
              <img src="/images/home/typescript.png"></img>
              <h2>TypeScript</h2>
            </div>
        ...
        <div className="work-section">
          ...
          <div className="work-section left-side">
            <span className="work-position">
              <h2>Fullstack Developer</h2> Big C Supercenter (Head Office)
            </span>
            <ul>
              <li>
                <span>
                  <strong>Developed backend services</strong> responsible for
                  calculating prices, managing store data, tracking products
                  stock, and handling user cart information as part of an
                  e-commerce platform using Rust programming and MySQL
                </span>
              </li>
              <li id="exp-2">
                <span>
                  <strong>Involved</strong> in designing the project structure
                  during initialization phase, ensured code performance in the
                  migration process from C++ to Rust
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="work-section">
          <div className="work-section left-side">
            <span className="work-position">
              <h2>Software Engineer (Frontend)</h2> N-squared eCommerce
            </span>
            <ul>
              <li>
                <span>
                  <strong>Developed</strong> a <strong>marketplace</strong>{" "}
                  management website for organizing and tracking merchandise
                </span>
              </li>
              <li id="exp-2">
                <span>
                  <strong>Delicately</strong> designed. Contributed in planning
                  and testing phases under <span>agile</span> project management
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="school-section">
          <div className="card intern">
            ...
            <ul>
              ...
              <li>
                NLP machine learning models for <strong>text-to-speech</strong>{" "}
                task using BERT and Transformer
              </li>
            </ul>
          </div>
          <div className="card ug-project">
            ...
            <p>
              Used <strong>deep learning</strong> to improved quality of
              upscaled images up to 8x from neural networks
            </p>
            ...
            <ImgComparisonSlider style={{ width: "15em" }}>
              <img
                slot="first"
                src="/images/home/ug-lr.png"
                style={{ height: "15em" }}
              />
              <img
                slot="second"
                src="/images/home/ug-hr.png"
                style={{ height: "15em" }}
              />
            </ImgComparisonSlider>
          </div>
          ...
          <div className="card activity">
            <span>
              <h2>2nd Prize winner in The Next AI Hackathon</h2>
              <span>
                Prototype a generative AI-powered customer service chat app to
                reduce costs, boost sales, and suggest personalized products
              </span>
            </span>
          </div>
          <div className="card language">
            <div className="lang-test">
              <h2>Languages</h2>
              <span className="lang-test-line-1">
                <strong>IELTS 7.0</strong> (CEFR C1)
              </span>
              <span className="lang-test-line-2">
                <strong>JLPT N2</strong> (Pre-advanced)
              </span>
            </div>
          ...
          {/* <div className="card certificate">
            <span>
              <h2>More info</h2>
              <a href="https://elegant-dragon-097141.netlify.app">
                visit old version HTML
              </a>
            </span>
